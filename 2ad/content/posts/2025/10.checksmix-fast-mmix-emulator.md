...
TRAP support is intentionally minimal. `TRAP 0,Halt,0` exits; `TRAP 0,Fputs,StdOut` walks a null-terminated string from `$255` and writes it to stdout or stderr. Unknown traps simply advance the PC and continue. For exploratory work and porting snippets from richer simulators, this is usually more helpful than halting or panicking.
...
# ----------------------------------------------------
        LOC     #100
# Entry point
Main    SET     $2,20            # compute fib(20)
        PUSHJ   $1,Fibonacci     # n is staged at $2, result lands at $1
        TRAP    0,Halt,0

# ----------------------------------------------------
# Registers used:
#   $0 = n on entry, result on exit
#   $1 = fib(n-2)
#   $2 = fib(n-1)
#   $3 = counter
#   $4 = temp
...
# calculate fib($0) and return result in $0
Fibonacci
        CMP     $4,$0,2
        BN      $4,TwoOrLess
        SET     $1,0
