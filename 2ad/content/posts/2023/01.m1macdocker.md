...
Link to [YouTube](https://youtu.be/GcJhvcVHiXI)
 ...
 Unfortunately, it turns out the MacOS scheduler almost immediately promotes intensive workloads to the performance cores. Therefore you should not enable efficiency cores on M1 Mac builds as it does not have a major impact.  Either way the scheduler will appropriately assign the workload.
