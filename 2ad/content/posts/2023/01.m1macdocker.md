...
Link to [YouTube](https://youtu.be/GcJhvcVHiXI)
 ...
 Unfortunately, it turns out the MacOS scheduler simply ignores these cores for performance intensive workloads.  Therefore you should not enable efficiency cores on M1 Mac Docker build.
